            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div id="current-image-container">
                        ...
                        <div class="relative">
                            <img src="{{ asset('storage/' . $menu->image) }}" alt="Current Image" class="w-full h-64 object-cover rounded-lg">
                        </div>
                    </div>
                    ...
                    <div id="new-image-preview-container" class="hidden">
                        ...
                        <div class="relative">
                            ...
                            <button type="button" onclick="removeNewImage()" class="absolute top-2 right-2 bg-red-500 text-white p-2 rounded-full hover:bg-red-600 focus:outline-none">
